BEGIN TRY
	...
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (1)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (2)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (3)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (4)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (5)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (6)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (7)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (8)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (9)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (10)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (11)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (12)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (13)
	INSERT [dbo].[MilitaryAward] ([MilitaryAwardId]) VALUES (14)

	SET IDENTITY_INSERT [dbo].[MilitaryAward] OFF
	----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (1, N'ეროვნული გმირის ორდენი', N'ეროვნული გმირის ორდენი, 
	...
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (2, N'წმინდა გიორგის სახელობის გამარჯვების ორდენი', N'წმინდა გიორგის 
	...
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (3, N'ბრწყინვალების საპრეზიდენტო ორდენი', N'ბრწყინვალების საპრეზიდენტო 
	...
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (4, N'დავით აღმაშენებლის ორდენი', N'დავით აღმაშენებელის ორდენი, საქართველოს 
	...
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (5, N'თამარ მეფის ორდენი', N'თამარ მეფის ორდენით ჯილდოვდებიან ქალები ქვეყნისა 
	...
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (6, N'წმინდა ნიკოლოზის ორდენი', N'წმინდა ნიკოლოზის ორდენით ჯილდოვდებიან  
	პირები ქველმოქმედებისათვის, ქვეყნისა და ხალხის უანგარო სამსახურისათვის.', 1)
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (7, N'ოქროს საწმისის ორდენი', N'ოქროს საწმისის ორდენით ჯილდოვდებიან უცხოელი 
	...
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (8, N'ვახტანგ გორგასლის ორდენი - I ხარისხი', N'ვახტანგ გორგასლის ორდენით 
	...
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (9, N'ვახტანგ გორგასლის ორდენი - II ხარისხი', N'ვახტანგ გორგასლის ორდენით  
	ჯილდოვდებიან საქართველოს სამხედრო მოსამსახურენი, რომლებმაც სამშობლოს დაცვისა და ერთიანობისათვის ბრძოლაში გამოიჩინეს გმირული თავდადება და მამაცობა, უზრუნველყვეს სამხედრო 
	...
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (10, N'ვახტანგ გორგასლის ორდენი - III ხარისხი', N'ვახტანგ გორგასლის ორდენით 
	ჯილდოვდებიან საქართველოს სამხედრო მოსამსახურენი, რომლებმაც სამშობლოს დაცვისა და ერთიანობისათვის ბრძოლაში გამოიჩინეს გმირული თავდადება და მამაცობა, უზრუნველყვეს სამხედრო 
	...
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (11, N'ღირსების ორდენი', N'ღირსების ორდენით ჯილდოვდებიან მოქალაქენი 
	...
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (12, N'მხედრული მამაცობის მედალი', N'მხედრული მამაცობის მედლით 
	...
	ოდენობით.', 1)
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (13, N'საბრძოლო დამსახურების მედალი', N'საბრძოლო დამსახურების მედლით 
	...
	INSERT [dbo].[MilitaryAwardTranslation] ([MilitaryAwardId], [AwardName], [Description], [LanguageId]) VALUES (14, N'ღირსების მედალი', N'ღირსების მედლით ჯილდოვდებიან საქართველოს 
