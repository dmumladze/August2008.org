...
Map.viewChangeEndHandler = function (credentials) {
    ...
    $("#slider-vertical").slider("value", Map.instance.getZoom());
};
...
Map.getLocations = function () {
    $.getJSON(Map.actionUrl, null, function (data, status, xhr) {
        ...
        Map.infoboxLayer.push(Map.pinInfobox);

        $.each(data, function (index, value) {
            var pin = new Microsoft.Maps.Pushpin(Map.instance.getCenter(), { typeName: "pushpin", icon: Map.pinIconUrl });
            ...
            Map.instance.entities.push(pin);
