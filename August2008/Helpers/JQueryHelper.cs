...
namespace August2008.Helpers
{
    public static class JQueryHelper
    {
        ...
        public static string JQueryDateFormat(this HtmlHelper html)
        {
            return JQueryDateFormat(html, Thread.CurrentThread.CurrentCulture.DateTimeFormat.ShortDatePattern);
        }
        /// <summary>
        /// Converts the .net supported date format current culture 
        /// format into JQuery Datepicker format.
        ...
        /// <returns>Format string that supported in JQuery Datepicker.</returns>
        public static string JQueryDateFormat(this HtmlHelper html, string format)
        {
            /*
